...
class NpmScriptsTreeDataProvider {
    ...
    async runInstall(selection) {
        ...
        const task = await (0, tasks_1.createTask)(await (0, tasks_1.getPackageManager)(this.context, selection.folder.workspaceFolder.uri, true), 'install', ['install'], selection.folder.workspaceFolder, uri, undefined, []);
