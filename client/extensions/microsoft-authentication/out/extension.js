...
function shouldUseMsal(expService) {
    ...
    if (inspect?.workspaceFolderValue !== undefined) {
        logger_1.default.debug(`Acquired MSAL enablement value from 'workspaceFolderValue'. Value: ${inspect.workspaceFolderValue}`);
        return inspect.workspaceFolderValue === 'msal';
    }
    if (inspect?.workspaceValue !== undefined) {
        logger_1.default.debug(`Acquired MSAL enablement value from 'workspaceValue'. Value: ${inspect.workspaceValue}`);
        return inspect.workspaceValue === 'msal';
    }
    if (inspect?.globalValue !== undefined) {
        logger_1.default.debug(`Acquired MSAL enablement value from 'globalValue'. Value: ${inspect.globalValue}`);
    ...
    if (expValue !== undefined) {
        logger_1.default.debug(`Acquired MSAL enablement value from 'exp'. Value: ${expValue}`);
        return expValue;
    }
    logger_1.default.debug('Acquired MSAL enablement value from default. Value: false');
