...
class ApiRepositoryState {
    ...
    get untrackedChanges() { return this._repository.untrackedGroup.resourceStates.map(r => new ApiChange(r)); }
...
class ApiRepository {
    constructor(repository) {
        ...
        this.onDidCommit = (0, util_1.mapEvent)((0, util_1.filterEvent)(this.repository.onDidRunOperation, e => e.operation === operation_1.Operation.Commit), () => null);
    }
    apply(patch, reverse) {
