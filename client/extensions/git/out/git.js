...
class Repository {
    ...
    async bufferString(object, encoding = 'utf8', autoGuessEncoding = false, candidateGuessEncodings = []) {
        const stdout = await this.buffer(object);
        if (autoGuessEncoding) {
            encoding = (0, encoding_1.detectEncoding)(stdout, candidateGuessEncodings) || encoding;
        }
        encoding = iconv.encodingExists(encoding) ? encoding : 'utf8';
    ...
    async diffTrees(treeish1, treeish2) {
