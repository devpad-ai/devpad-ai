...
class LanguageProvider extends dispose_1.Disposable {
    ...
    async registerProviders() {
        ...
        await Promise.all([
            ...
            Promise.resolve().then(() => __importStar(require('./languageFeatures/copyPaste'))).then(provider => this._register(provider.register(selector, this.description, this.client))),
            ...
            Promise.resolve().then(() => __importStar(require('./languageFeatures/mappedCodeEditProvider'))).then(provider => this._register(provider.register(selector, this.client))),
